         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images\logo.png" alt="" height=55> </a>
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="https://media.istockphoto.com/id/1281150061/vector/register-account-submit-access-login-password-username-internet-online-website-concept.jpg?s=612x612&w=0&k=20&c=9HWSuA9IaU4o-CK6fALBS5eaO1ubnsM08EOYwgbwGBo=" alt="" class="img-fluid">
                        <p>Frequently Asked?</p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>What is Kattu Soru app Do than Others in Market</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body">We value our customer’s time and choice of Eating Delicious From Their Faviroute Place We Help to connect With them with their Food and Place </div>
                           </div>
                        </div>
                        <!-- end:panel -->
